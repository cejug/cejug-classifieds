...
public class ClassifiedsAdminSessionBean implements ClassifiedsAdminRemote, ClassifiedsAdminLocal {
  ...
  public ServiceStatus addQuotaOperation(final AddQuotaInfo addQuotaRequest) {
    ...
    try {
      ...
      CustomerEntity customer = customerFacade.findOrCreate(requestedQuota.getDomainId(),
          requestedQuota.getCustomerLogin());
      ...
      AdvertisementTypeEntity type = advTypeFacade.read(AdvertisementTypeEntity.class,
          Integer.valueOf(requestedQuota.getAdvertisementTypeId()));
      ...
      logger.finest("TODO: fix logging... 1 {0} quota added to customer {1} of domain {2}");
    } catch (Exception e) {
      // TODO: log.............
  ...
  public ServiceStatus createCategoryOperation(final CreateCategoryParam newCategory) {
    ...
    AdvertisementCategory advertisementCategory = newCategory.getAdvertisementCategory();
    CategoryEntity category = fillCategoryEntity(advertisementCategory);
    AdvertisementCategory parent = advertisementCategory.getAdvertisementCategory();
    if (parent != null) {
  ...
  @Override
  public CategoryCollection readCategoryBundleOperation(final ReadCategoryBundleParam getCategories) {
      ...
      if (categories != null) {
        for (CategoryEntity category : categories) {
          ...
          if (category.getParent() != null) {
            cat.setAdvertisementCategory(fillAdvertisementCategory(category.getParent()));
          }
  ...
  private AdvertisementCategory fillAdvertisementCategory(final CategoryEntity entity) {
  ...
  private CategoryEntity fillCategoryEntity(AdvertisementCategory advertisementCategory) {
