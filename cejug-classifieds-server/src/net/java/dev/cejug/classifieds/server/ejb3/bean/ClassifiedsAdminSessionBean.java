...
public class ClassifiedsAdminSessionBean implements ClassifiedsAdminRemote, ClassifiedsAdminLocal {
  ...
  @EJB
  private ServiceLifeCycleFacadeLocal lifeCycleFacade;

  /**
   * the global log manager, used to al low third party services to override the
   * defult logger.
   */
  private static Logger logger = Logger.getLogger(ClassifiedsAdminSessionBean.class.getName(),
      "i18n/log");
  ...
  private AdvertisementCategory fillAdvertisementCategory(CategoryEntity entity) {
