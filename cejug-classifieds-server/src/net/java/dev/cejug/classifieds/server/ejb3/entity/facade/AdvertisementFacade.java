 ...
 */
@Stateless
public class AdvertisementFacade extends EntityFacade<AdvertisementEntity> implements AdvertisementFacadeLocal {
    ...
    public void createAdvertisement(AdvertisementEntity entity) throws Exception {
