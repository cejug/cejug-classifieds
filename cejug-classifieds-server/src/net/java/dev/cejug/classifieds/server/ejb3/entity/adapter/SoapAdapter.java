...
public abstract class SoapAdapter<SoapType, EntityType> {
   ...
   * 
   * @param type the JPA entity.
   * @return a soap object containing the values of the entity.
   */
  protected abstract SoapType toSoap(EntityType type);
   ...
   */
  protected abstract EntityType toEntity(SoapType type);
